...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ede-compdb" '("ff-other-file-list" "parse-command-line" "project-" "initialize-instance" "insert-compdb" "ede-" "current-co" "compdb-entry" "other-file-list" "set-configuration-directory" "get-")))
