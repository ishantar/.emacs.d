...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "inferior-lfe" '("inferior-lfe-" "switch-to-lfe" "lfe-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "lfe-indent" '("define-lfe-indent" "put-lfe-indent" "lfe-")))
