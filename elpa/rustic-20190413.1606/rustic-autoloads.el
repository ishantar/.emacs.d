...
(autoload 'rustic-cargo-build "rustic-cargo" nil t nil)

(autoload 'rustic-cargo-run "rustic-cargo" nil t nil)

(autoload 'rustic-cargo-clean "rustic-cargo" nil t nil)

(autoload 'rustic-cargo-check "rustic-cargo" nil t nil)

(autoload 'rustic-cargo-bench "rustic-cargo" nil t nil)
...
Enable formatting using rustfmt when saving buffer." t nil)

(autoload 'rustic-format--disable-format-on-save "rustic-util" "\
Disable formatting using rustfmt when saving buffer." t nil)
