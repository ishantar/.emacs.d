...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "inf-shen" '("inferior-shen-" "switch-to-shen" "shen-" "check-balanced-parens")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "shen-mode" '("shen-")))
